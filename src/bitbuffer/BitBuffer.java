...
/**
 * https://github.com/magik6k/BitBuffer
 * <p>
...
public abstract class BitBuffer {
    ...
    /**
     * Puts {@link String} value(8 bits per char), using UTF-8 encoding. NULL TERMINATED
     *
    ...
    /**
     * @param mFloat value to set
     * @return This buffer
     * @see #putFloat(float)
     */
    public BitBuffer put(float mFloat) {
        return putFloat(mFloat);
    }
